...
class SoundPlayer {
    ...
    private final int soundMessage;
    ...
    SoundPlayer(Context context) {
        ...
        // TODO: 音の差し替え
        soundMessage = soundPool.load(context, R.raw.glass_break3, 1);
    }
    ...
    void playSoundMessage() {
        soundPool.play(soundMessage, 1.0f, 1.0f, 0, 0, 1);
    }
}
